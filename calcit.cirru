...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `calcit query` to inspect and `calcit edit`/`calcit tree` to modify. Run `calcit docs agents --full` first. Manual edits must follow format and schema conventions, then run `calcit edit format`.") (:package |corokia)
  :entries $ {}
    :default $ {} (:description |) (:init-fn 'corokia.main/main!) (:mode :native) (:reload-fn 'corokia.main/reload!)
      :feature-policy $ {}
    ...
    'corokia.comp $ %{} 'FileEntry
      :defs $ {}
        ...
        'c-length $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Dynamic
          :tests $ []
            %{} 'TestEntry (:name |computes-three-four-five)
              :code $ quote
                assert= 5 $ c-length ([] 3 4)
    ...
    'corokia.complex $ %{} 'FileEntry
      :defs $ {}
        'c* $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Dynamic
          :tests $ []
            %{} 'TestEntry (:name |multiplies-complex-pairs)
              :code $ quote
                assert= ([] -5 10)
                  c* ([] 1 2) ([] 3 4)
        'c+ $ %{} 'CodeEntry (:doc |)
        ...
        'c- $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Dynamic
          :tests $ []
            %{} 'TestEntry (:name |subtracts-pairs)
              :code $ quote
                assert= ([] -2 -2)
                  c- ([] 1 2) ([] 3 4)
          ...
          :code $ quote
            defn get-shape-tree (tree)
              if (nil? tree) nil $ case-default (open-field tree :type) tree
                ...
                :group $ if (open-field tree :pure-shape?) tree
    ...
    'corokia.main $ %{} 'FileEntry
      :defs $ {}
        ...
        'reload! $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn reload! () (reset-memof1-caches!) (println |reloaded) (render-page)
          :examples $ []
          :schema $ :: 'Dynamic
        'render-page $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn render-page () $ render-app!
              comp-container $ deref *store
          :examples $ []
          :schema $ :: 'Dynamic
